...
```{r}
integer_iter <- generator(function() for (x in 1:10) yield(x))
square_iter <- generator(function() for (x in integer_iter) yield(x^2))
```

The `gen()` alias is a shortcut for creating small generator functions:
